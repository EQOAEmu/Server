...
//TODO we currently use structs for all of these
//need to move to files or database
...
void UDPServer::SetIp(char const* ip)
{
...
void UDPServer::StartRecv()
{
  ...
  socket_.async_receive_from(boost::asio::buffer(_recv_buffer), remote_endpoint_,
