...
//TODO
//fix hardcoded read size here
//right now we are just worried about one TCP packet from the client
...
//hardcoded to only handle the connection request
...
//TODO
//fix hardcoded write size here
//right now we are just worried about one TCP packet from the client
//that establishes the connection
//so we only focus on our one response
